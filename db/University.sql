...
CREATE TABLE `Student` (
  ...
  CONSTRAINT `Student_ibfk_3` FOREIGN KEY (`Roll_Number`) REFERENCES `Users` (`identification`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `users` WRITE;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` VALUES (1,'Vinay','$2y$10$djrfTMgcu.vL4lYKkUWaneBsA3MoKlaGxIwdYAbyVUj9Tff4/jrAC','2019-04-03 15:38:53');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-04-04 13:32:14
